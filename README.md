...
```js
const OsmPbfReader = require('@luiz.weber/osm-pbf-io').Reader;
...
```js
const OsmPbfTypes = require('@luiz.weber/osm-pbf-io').Types;
const OsmPbfWriter = require('@luiz.weber/osm-pbf-io').Writer;
